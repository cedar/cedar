...
void Object::setPosition( cv::Mat position )
{
...
{
  mOrientationAngles.at<double>( 0, 0 ) = alpha;
  mOrientationAngles.at<double>( 1, 0 ) = beta;
  mOrientationAngles.at<double>( 2, 0 ) = gamma;
  updateTransformation();
}

void Object::setOrientationAngles( cv::Mat angles )
{
  mOrientationAngles = angles.clone();
  updateTransformation();
}
