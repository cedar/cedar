...
#ifndef CEDAR_AUX_GUI_QC_MATRIX_PLOT_H
#define CEDAR_AUX_GUI_QC_MATRIX_PLOT_H
...
#include "cedar/auxiliaries/gui/QCMatrixPlot.fwd.h"
 ...
 */
class cedar::aux::gui::QCMatrixPlot : public cedar::aux::gui::MultiPlotInterface
{
  //--------------------------------------------------------------------------------------------------------------------
  // macros
  //--------------------------------------------------------------------------------------------------------------------
...
public:
  ...
  QCMatrixPlot(QWidget *pParent = NULL);
...
}; // class cedar::aux::gui::QCMatrixPlot

#endif // CEDAR_AUX_GUI_QC_MATRIX_PLOT_H
