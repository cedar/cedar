...
========================================================================================================================
    ...
    File:        QC2DMatrixPlot.cpp

    Maintainer:  Lars Janssen
    Email:       lars.janssen@ini.rub.de
    Date:        2023 09 05

    Description: Source file for the class cedar::aux::gui::QC2DMatrixPlot.
...
#include "cedar/auxiliaries/gui/QC2DMatrixPlot.h"
...
namespace
{
  bool registerPlot()
  {
    ...
    using cedar::aux::gui::QC2DMatrixPlot;

    typedef cedar::aux::gui::PlotDeclarationTemplate<MatData, QC2DMatrixPlot> DeclarationType;
...
cedar::aux::gui::QC2DMatrixPlot::QC2DMatrixPlot(QWidget *pParent)
:
...
void cedar::aux::gui::QC2DMatrixPlot::readConfiguration(const cedar::aux::ConfigurationNode& configuration)
{
...
void cedar::aux::gui::QC2DMatrixPlot::writeConfiguration(cedar::aux::ConfigurationNode& configuration) const
{
  if (auto configurable = dynamic_cast<cedar::aux::Configurable*>(this->mpCurrentPlotWidget))
  {
...
bool cedar::aux::gui::QC2DMatrixPlot::canAppend(cedar::aux::ConstDataPtr data) const
{
...
void cedar::aux::gui::QC2DMatrixPlot::doAppend(cedar::aux::ConstDataPtr data, const std::string& title)
{
...
bool cedar::aux::gui::QC2DMatrixPlot::canDetach(cedar::aux::ConstDataPtr data) const
{
  if (this->mpCurrentPlotWidget == nullptr)
  {
    return false;
...
void cedar::aux::gui::QC2DMatrixPlot::doDetach(cedar::aux::ConstDataPtr data)
{
  CEDAR_DEBUG_ASSERT(this->mpCurrentPlotWidget != nullptr);
  auto p_multi_plot = dynamic_cast<cedar::aux::gui::MultiPlotInterface*>(this->mpCurrentPlotWidget);
...
void cedar::aux::gui::QC2DMatrixPlot::plot(cedar::aux::ConstDataPtr data, const std::string& title)
{
  this->mData= boost::dynamic_pointer_cast<cedar::aux::ConstMatData>(data);
  if (!this->mData)
  {
    CEDAR_THROW(cedar::aux::gui::InvalidPlotData,
                "Cannot cast to cedar::aux::MatData in cedar::aux::gui::QC2DMatrix::plot.");
  }
  ...
  switch (dims)
  {
    case 2:
    {
      this->mpCurrentPlotWidget = new cedar::aux::gui::ImagePlot(this->mData, title, NULL, true);
    ...
    case UINT_MAX:
    {
      std::string message = "The QC2D matrix plot widget can not handle empty matrices.";
    ...
    default:
    {
      std::string message = "The QC2D matrix plot widget can not handle a matrix with the given dimensionality (";
...
void cedar::aux::gui::QC2DMatrixPlot::processChangedData()
{
