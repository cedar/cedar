...
#ifndef CEDAR_AUX_GUI_QT5HISTORY_PLOT_0D_H
#define CEDAR_AUX_GUI_QT5HISTORY_PLOT_0D_H
...
#include "cedar/auxiliaries/gui/Qt5HistoryPlot0D.fwd.h"
 ...
 */
class cedar::aux::gui::Qt5HistoryPlot0D : public cedar::aux::gui::MultiPlotInterface
{
  //--------------------------------------------------------------------------------------------------------------------
  // macros
  //--------------------------------------------------------------------------------------------------------------------
...
public:
  ...
  Qt5HistoryPlot0D(QWidget *pParent = NULL);

  //!@brief Constructor that expects a DataPtr
  Qt5HistoryPlot0D(cedar::aux::ConstDataPtr matData, const std::string& title, QWidget *pParent = NULL);
...
//#endif // CEDAR_USE_QWT
  cedar::aux::gui::Qt5LinePlot* mpHistoryPlot;
