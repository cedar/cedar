...
#ifndef CEDAR_AUX_GUI_SCENE_CONTROL_FWD_H
#define CEDAR_AUX_GUI_SCENE_CONTROL_FWD_H
...
namespace cedar
{
  namespace aux
  {
    namespace gui
    {
      CEDAR_DECLARE_AUX_CLASS(SceneControl);
    }
  }
}
...
#endif // CEDAR_AUX_GUI_SCENE_CONTROL_FWD_H
