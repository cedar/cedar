...
namespace cedar
{
  namespace aux
  {
    template <typename T, typename R> class Clonable
    {
      public:
        typedef T ClonedType;
        typedef R ReturnedType;
...
public cedar::aux::Clonable<cedar::aux::annotation::Dimensions, cedar::aux::annotation::Annotation>
{
  //--------------------------------------------------------------------------------------------------------------------
  // nested types
  //--------------------------------------------------------------------------------------------------------------------
