...
========================================================================================================================
    ...
    File:        AccelerationLimitsParameter.h

    Maintainer:  Stephan Zibner
    Email:       stephan.zibner@ini.rub.de
    Date:        2013 02 27

    Description: This is a dummy header for the typedef AccelerationLimitsParameter (which is actually a
                 cedar::aux::math::LimitsParameter<cedar::unit::Acceleration>).

    Credits:

======================================================================================================================*/

#ifndef CEDAR_AUX_MATH_ACCELERATION_LIMITS_PARAMETER_H
