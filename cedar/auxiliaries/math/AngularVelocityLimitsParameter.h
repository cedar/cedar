...
========================================================================================================================
    ...
    File:        AngularVelocityLimitsParameter.h

    Maintainer:  Stephan Zibner
    Email:       stephan.zibner@ini.rub.de
    Date:        2013 02 27

    Description: This is a dummy header for the typedef AngularVelocityLimitsParameter (which is actually a
                 cedar::aux::math::LimitsParameter<cedar::unit::AngularVelocity>).

    Credits:

======================================================================================================================*/

#ifndef CEDAR_AUX_MATH_ANGULAR_VELOCITY_LIMITS_PARAMETER_H
#define CEDAR_AUX_MATH_ANGULAR_VELOCITY_LIMITS_PARAMETER_H
