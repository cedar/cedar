...
========================================================================================================================
    ...
    File:        PlaneAngleLimitsParameter.h

    Maintainer:  Stephan Zibner
    Email:       stephan.zibner@ini.rub.de
    Date:        2013 02 27

    Description: This is a dummy header for the typedef PlaneAngleLimitsParameter (which is actually a
                 cedar::aux::math::LimitsParameter<cedar::unit::PlaneAngle>).

    Credits:

======================================================================================================================*/

#ifndef CEDAR_AUX_MATH_PLANE_ANGLE_LIMITS_PARAMETER_H
