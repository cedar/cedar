...
========================================================================================================================
    ...
    File:        VelocityLimitsParameter.h

    Maintainer:  Stephan Zibner
    Email:       stephan.zibner@ini.rub.de
    Date:        2013 02 27

    Description: This is a dummy header for the typedef VelocityLimitsParameter (which is actually a
                 cedar::aux::math::LimitsParameter<cedar::unit::Velocity>).

    Credits:

======================================================================================================================*/

#ifndef CEDAR_AUX_MATH_VELOCITY_LIMITS_PARAMETER_H
#define CEDAR_AUX_MATH_VELOCITY_LIMITS_PARAMETER_H
