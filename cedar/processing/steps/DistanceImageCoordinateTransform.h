...
========================================================================================================================
    ...
    File:        DistanceImageCoordinateTransform.h

    Maintainer:  Jan Tekuelve
    Email:       jan.tekuelve@ini.rub.de
    Date:        2022 03 02

    Description: Header file for the class cedar::proc::steps::DistanceImageCoordinateTransform.

    Credits:

======================================================================================================================*/

#ifndef CEDAR_PROC_STEPS_DISTANCE_IMAGE_COORDINATE_TRANSFORM_H
#define CEDAR_PROC_STEPS_DISTANCE_IMAGE_COORDINATE_TRANSFORM_H
...
#include "cedar/processing/steps/DistanceImageCoordinateTransform.fwd.h"
 ...
 * @todo describe more.
 */
class cedar::proc::steps::DistanceImageCoordinateTransform: public cedar::proc::Step
{
  //--------------------------------------------------------------------------------------------------------------------
  // macros
  //--------------------------------------------------------------------------------------------------------------------
...
public:
  ...
  DistanceImageCoordinateTransform();

  //!@brief Destructor
  virtual ~DistanceImageCoordinateTransform();
...
private:
    ...
    std::string mAlloOutputName = "allocentric representation";
...
}; // class cedar::proc::steps::DistanceImageCoordinateTransform

#endif // CEDAR_PROC_STEPS_DISTANCE_IMAGE_COORDINATE_TRANSFORM_H
