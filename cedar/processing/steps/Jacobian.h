...
#ifndef CEDAR_PROC_STEPS_JACOBIAN_STEP_H
#define CEDAR_PROC_STEPS_JACOBIAN_STEP_H
...
#include "cedar/processing/steps/Jacobian.fwd.h"
 ...
 * @todo describe more.
 */
class cedar::proc::steps::Jacobian : public cedar::proc::Step
{
Q_OBJECT
  //--------------------------------------------------------------------------------------------------------------------
  // nested types
...
#endif // CEDAR_PROC_STEPS_JACOBIAN_STEP_H
