...
========================================================================================================================
    ...
    Description: Source file for the class cedar::proc::steps::InnerProduct.
...
// CLASS HEADER
#include "cedar/processing/steps/InnerProduct.h"
...
bool declare()
{
  ...
  (
    new ElementDeclarationTemplate<cedar::proc::steps::InnerProduct>
    (
      "Algebra",
  ...
  declaration->setIconPath(":/steps/inner_product.svg");
  declaration->setDescription
  (
    "Implements a Dot (inner) product between two vectors."
  );
...
cedar::proc::steps::InnerProduct::InnerProduct()
:
// outputs
...
void cedar::proc::steps::InnerProduct::inputConnectionChanged(const std::string& inputName)
{
  if (inputName == "input")
  {
...
void cedar::proc::steps::InnerProduct::compute(const cedar::proc::Arguments&)
{
  this->recompute();
}

void cedar::proc::steps::InnerProduct::recompute()
{
  ...
  this->mOutput->getData().at<float>(0,0)=
    data->getData().dot( data2->getData() );
