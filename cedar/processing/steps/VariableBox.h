...
#ifndef CEDAR_PROC_SOURCES_VARIABLE_BOX_H
#define CEDAR_PROC_SOURCES_VARIABLE_BOX_H
...
#include "cedar/processing/steps/VariableBox.fwd.h"
 ...
 */
class cedar::proc::steps::VariableBox : public cedar::proc::Step
{
  //--------------------------------------------------------------------------------------------------------------------
  // macros
  //--------------------------------------------------------------------------------------------------------------------
