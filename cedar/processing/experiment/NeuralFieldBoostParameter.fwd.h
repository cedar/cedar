...
========================================================================================================================
    ...
    Description: Forward declaration file for the class cedar::proc::experiment::NeuralFieldBoostParameter.
...
namespace cedar
{
  namespace proc
  {
    ...
    {
        CEDAR_DECLARE_PROC_CLASS_INTRUSIVE(NeuralFieldBoostParameter);
    }
  }
}
