...
mpExperimentDialog(nullptr)
{
  ...
  QObject::connect(this->mpActionStartPauseSimulation, SIGNAL(triggered()), this, SLOT(startPauseSimulationToggled()));
...
void cedar::proc::gui::Ide::startPauseSimulationToggled()
{
