...
{
  this->resetTo(cedar::proc::gui::NetworkFilePtr(new cedar::proc::gui::Network(this, this->mpProcessingDrawer->getScene())));
}
...
{
  this->newFile();
  cedar::proc::gui::NetworkFilePtr network(new cedar::proc::gui::Network(this, this->mpProcessingDrawer->getScene()));
