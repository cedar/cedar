...
#include "cedar/processing/auxiliaries/gui/NumericVectorParameter.fwd.h"
...
class cedar::proc::aux::gui::NumericVectorParameterAbstraction
:
public cedar::proc::aux::gui::VectorParameterAbstraction<ValueT, WidgetT>
{
  public:
 ...
 */
template <typename ValueT, class WidgetT>
class cedar::proc::aux::gui::NumericVectorParameter : public cedar::proc::aux::gui::VectorParameter
                                                       <
                                                         ValueT,
                                                         WidgetT,
                                                         cedar::proc::aux::gui::NumericVectorParameterAbstraction
                                                         <
                                                           ValueT, WidgetT
                                                         >
                                                       >
{
  ...
  //--------------------------------------------------------------------------------------------------------------------
private:
  typedef cedar::proc::aux::gui::VectorParameter
          <
            ValueT,
            WidgetT,
            cedar::proc::aux::gui::NumericVectorParameterAbstraction
...
private:
  // none yet
}; // class cedar::proc::aux::gui::NumericVectorParameter
