...
#include "cedar/processing/auxiliaries/gui/EnumParameter.fwd.h"
 ...
 */
class cedar::proc::aux::gui::EnumParameter : public cedar::proc::aux::gui::Parameter
{
  //--------------------------------------------------------------------------------------------------------------------
  // macros
  //--------------------------------------------------------------------------------------------------------------------
...
}; // class cedar::proc::aux::gui::EnumParameter
