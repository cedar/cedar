...
#include "cedar/processing/auxiliaries/gui/DoubleParameter.fwd.h"
  ...
  namespace proc
  {
    namespace aux
    {
      namespace gui
      {
        ...
        template<>
        inline void NumericWidgetPolicy<double, cedar::proc::aux::gui::IgnoreLocaleDoubleSpinBox>::setPrecision(
                cedar::proc::aux::gui::IgnoreLocaleDoubleSpinBox *pWidget, int precision)
        {
        ...
        //      //!@cond SKIPPED_DOCUMENTATION
        //      template<>
        //      inline void NumericWidgetPolicy<double, cedar::proc::aux::gui::IgnoreLocaleDoubleSpinBox>::manuallyChangedValue(cedar::proc::aux::gui::IgnoreLocaleDoubleSpinBox* pWidget, const double& newvalue, const double& oldvalue)
        //      {
 ...
 */
class cedar::proc::aux::gui::DoubleParameter : public cedar::proc::aux::gui::NumericParameter<double, cedar::proc::aux::gui::IgnoreLocaleDoubleSpinBox>
{
  //--------------------------------------------------------------------------------------------------------------------
  // macros
  //--------------------------------------------------------------------------------------------------------------------
  ...
  //--------------------------------------------------------------------------------------------------------------------
private:
  typedef cedar::proc::aux::gui::NumericParameter<double, cedar::proc::aux::gui::IgnoreLocaleDoubleSpinBox> Base;
...
}; // class cedar::proc::aux::gui::DoubleParameter
