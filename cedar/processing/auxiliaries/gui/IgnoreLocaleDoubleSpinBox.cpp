...
========================================================================================================================
    ...
    Description: Source file for the class cedar::proc::aux::gui::IgnoreLocaleDoubleSpinBox.
...
cedar::proc::aux::gui::IgnoreLocaleDoubleSpinBox::IgnoreLocaleDoubleSpinBox(QWidget *parent)
...
cedar::proc::aux::gui::IgnoreLocaleDoubleSpinBox::~IgnoreLocaleDoubleSpinBox()
{
}
...
// methods
//----------------------------------------------------------------------------------------------------------------------
double cedar::proc::aux::gui::IgnoreLocaleDoubleSpinBox::valueFromText(const QString& text) const
{
...
double cedar::proc::aux::gui::IgnoreLocaleDoubleSpinBox::getLastDefinedDigit(std::string textInput) const
{
...
void cedar::proc::aux::gui::IgnoreLocaleDoubleSpinBox::updatePrecision(double newPrecision)
{
//  std::cout<<"Received a signal to update the precision to: "<< newPrecision << std::endl;
  this->mLastDefinedDigit = newPrecision;
}

void cedar::proc::aux::gui::IgnoreLocaleDoubleSpinBox::keyPressEvent(QKeyEvent *event)
{
