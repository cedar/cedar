...
class cedar::proc::aux::gui::VectorParameterAbstraction
{
  //--------------------------------------------------------------------------------------------------------------------
  // public methods
  //--------------------------------------------------------------------------------------------------------------------
public:
   ...
   */
  static bool connectValueChange(cedar::proc::aux::gui::Parameter* /* pParameter */, WidgetT* /* pWidget */)
  {
...
<
  typename ValueT,
  class WidgetT,
  class Abstraction = cedar::proc::aux::gui::VectorParameterAbstraction<ValueT, WidgetT>
>
class cedar::proc::aux::gui::VectorParameter : public cedar::proc::aux::gui::Parameter,
                                         public Abstraction
{
  //--------------------------------------------------------------------------------------------------------------------
  // nested types
...
}; // class cedar::proc::aux::gui::VectorParameter
