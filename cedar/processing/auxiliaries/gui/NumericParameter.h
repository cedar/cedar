...
class cedar::proc::aux::gui::NumericWidgetPolicy
{
  public:
...
class cedar::proc::aux::gui::NumericParameter : public cedar::proc::aux::gui::Parameter,
                                          cedar::proc::aux::gui::NumericWidgetPolicy<ValueT, WidgetType>
{
  //--------------------------------------------------------------------------------------------------------------------
  // nested types
  //--------------------------------------------------------------------------------------------------------------------
public:
  ...
  typedef cedar::proc::aux::gui::NumericWidgetPolicy<ValueT, WidgetType> WidgetPolicy;
...
}; // class cedar::proc::aux::gui::NumericParameter
