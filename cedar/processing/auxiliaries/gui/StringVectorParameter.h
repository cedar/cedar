...
#include "cedar/processing/auxiliaries/gui/StringVectorParameter.fwd.h"
  ...
  namespace proc
  {
    namespace aux
    {
      namespace gui
      {
        ...
        {
          return QObject::connect(pWidget, SIGNAL(textChanged(const QString&)), pParameter,
                                  SLOT(widgetValueChanged(const QString&)));
        }
        //!@endcond
 ...
 */
class cedar::proc::aux::gui::StringVectorParameter : public cedar::proc::aux::gui::VectorParameter
                                                    <
                                                      std::string,
                                                      QLineEdit
                                                    >
{
  ...
  //--------------------------------------------------------------------------------------------------------------------
private:
  typedef cedar::proc::aux::gui::VectorParameter<std::string, QLineEdit> Base;
...
}; // class cedar::proc::aux::gui::StringVectorParameter
