...
namespace
{
  bool registered = cedar::proc::aux::gui::ParameterFactorySingleton::getInstance()->add
      <
        ...
        cedar::proc::aux::gui::IntVectorParameter
      >();
}
...
cedar::proc::aux::gui::IntVectorParameter::IntVectorParameter(QWidget *pParent)
:
cedar::proc::aux::gui::IntVectorParameter::Base(pParent)
{
}
...
void cedar::proc::aux::gui::IntVectorParameter::widgetValueChanged(int)
{
