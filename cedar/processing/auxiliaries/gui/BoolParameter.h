...
#include "cedar/processing/auxiliaries/gui/BoolParameter.fwd.h"
 ...
 */
class cedar::proc::aux::gui::BoolParameter : public cedar::proc::aux::gui::Parameter
{
  //--------------------------------------------------------------------------------------------------------------------
  // macros
  //--------------------------------------------------------------------------------------------------------------------
...
}; // class cedar::proc::aux::gui::BoolParameter
