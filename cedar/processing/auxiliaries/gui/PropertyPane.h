...
#include "cedar/processing/auxiliaries/gui/PropertyPane.fwd.h"
 ...
 *
 */
class cedar::proc::aux::gui::PropertyPane : public QTableWidget
{
  //--------------------------------------------------------------------------------------------------------------------
  // macros
  //--------------------------------------------------------------------------------------------------------------------
...
private:
  ...
  /*!@brief In events sent by cedar::proc::aux::gui::Parameters, this function returns the row displaying the sender.
   */
...
private:
  ...
  //! Association from cedar::proc::aux::gui::Parameters to rows.
  std::map<cedar::proc::aux::gui::Parameter*, int> mParameterWidgetRowIndex;
...
}; // class cedar::proc::aux::gui::PropertyPane
