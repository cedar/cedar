...
cedar::proc::aux::gui::Configurable::DataDelegate::DataDelegate
(
  cedar::proc::aux::gui::Configurable* configurableWidget,
  bool readOnly
)
:
...
cedar::proc::aux::gui::Configurable::DataDelegate::~DataDelegate()
{
  while (!this->mOpenedEditors.empty())
  {
    ...
    // this will also remove the widget from the set of open editors via cedar::proc::aux::gui::Configurable::DataDelegate::widgetDestroyed.
    delete widget;
  }
}

QWidget* cedar::proc::aux::gui::Configurable::DataDelegate::createEditor(QWidget *pParent, const QStyleOptionViewItem& /*option*/, const QModelIndex &index) const
{
  ...
  try
  {
    cedar::proc::aux::gui::Parameter *p_widget
      = cedar::proc::aux::gui::ParameterFactorySingleton::getInstance()->get(parameter)->allocateRaw();
...
void cedar::proc::aux::gui::Configurable::DataDelegate::widgetDestroyed(QObject* removed)
{
...
class cedar::proc::aux::gui::Configurable::ParameterItem : public QTreeWidgetItem
{
public:
...
cedar::proc::aux::gui::Configurable::Configurable(QWidget* pParent)
:
QWidget(pParent)
{
...
cedar::proc::aux::gui::Configurable::~Configurable()
{
  this->clear();
}
...
int cedar::proc::aux::gui::Configurable::getRootIndexForItem(QTreeWidgetItem* pItem) const
{
...
cedar::aux::ParameterPtr cedar::proc::aux::gui::Configurable::parameterFromModelIndex(const QModelIndex& index)
{
...
void cedar::proc::aux::gui::Configurable::translateParameterAddedSignal(unsigned int configurableIndex, cedar::aux::ParameterPtr parameter)
{
  QString path = QString::fromStdString(parameter->getName());
  emit parameterAdded(static_cast<int>(configurableIndex), path);
}

void cedar::proc::aux::gui::Configurable::translateParameterRemovedSignal(unsigned int configurableIndex, cedar::aux::ParameterPtr parameter)
{
...
void cedar::proc::aux::gui::Configurable::translateParameterNameChangedSignal(unsigned int configurableIndex, const std::string& oldName, const std::string& newName)
{
...
void cedar::proc::aux::gui::Configurable::parameterAddedSlot(int configurableIndex, QString path)
{
...
void cedar::proc::aux::gui::Configurable::parameterRemovedSlot(int /* configurableIndex */, QVariant parameterP)
{
...
void cedar::proc::aux::gui::Configurable::parameterRenamedSlot(int configurableIndex, QString /* oldName */, QString newName)
{
...
void cedar::proc::aux::gui::Configurable::fitRowsToContents()
{
  this->mpPropertyTree->doItemsLayout();
}

QTreeWidgetItem* cedar::proc::aux::gui::Configurable::appendHeading(QTreeWidgetItem* pParent, const QString& text, int hLevel)
{
...
void cedar::proc::aux::gui::Configurable::makeHeading(QTreeWidgetItem* pItem, const QString& text, int hLevel)
{
...
void cedar::proc::aux::gui::Configurable::display(std::vector<cedar::aux::ConfigurablePtr> configurables)
{
  this->clear();

  this->mpPropertyTree->setItemDelegateForColumn(PARAMETER_EDITOR_COLUMN, new cedar::proc::aux::gui::Configurable::DataDelegate(this, false));
...
void cedar::proc::aux::gui::Configurable::display(cedar::aux::ConfigurablePtr configurable, bool readOnly)
{
  this->clear();
  
  this->mpPropertyTree->setItemDelegateForColumn(PARAMETER_EDITOR_COLUMN, new cedar::proc::aux::gui::Configurable::DataDelegate(this, readOnly));

  this->appendRootConfigurable(configurable);
}

void cedar::proc::aux::gui::Configurable::appendRootConfigurable(cedar::aux::ConfigurablePtr configurable)
{
  ...
  this->mParameterAddedConnection = configurable->connectToParameterAddedSignal
                                    (
                                      boost::bind
                                      (
                                        &cedar::proc::aux::gui::Configurable::translateParameterAddedSignal,
                                        this,
                                        index,
                                        _1
                                      )
  ...
  this->mParameterRemovedConnection = configurable->connectToParameterRemovedSignal
                                      (
                                        boost::bind
                                        (
                                          &cedar::proc::aux::gui::Configurable::translateParameterRemovedSignal,
                                          this,
                                          index,
                                          _1
                                        )
...
void cedar::proc::aux::gui::Configurable::append(size_t configurableIndex, cedar::aux::ConfigurablePtr configurable, QTreeWidgetItem* pItem, const std::string& pathSoFar)
{
...
void cedar::proc::aux::gui::Configurable::append(size_t configurableIndex, cedar::aux::ParameterPtr parameter, QTreeWidgetItem* pNode, const std::string& pathSoFar)
{
  ...
  this->mParameterRenamedConnections[parameter.get()] =
                  ...
                  (
                    boost::bind
                    (
                      &cedar::proc::aux::gui::Configurable::translateParameterNameChangedSignal,
                      this,
                      configurableIndex,
                      _1,
                      _2
...
void cedar::proc::aux::gui::Configurable::appendObjectListParameter
(
...
void cedar::proc::aux::gui::Configurable::handleDeleteButtonClicked(QString fullPath)
{
...
void cedar::proc::aux::gui::Configurable::objectListParameterValueChanged()
{
...
void cedar::proc::aux::gui::Configurable::objectParameterValueChanged()
{
  auto p_parameter = dynamic_cast<cedar::aux::Parameter*>(QObject::sender());
  CEDAR_DEBUG_ASSERT(p_parameter != nullptr);
  ...
  if (item == nullptr)
  {
    ...
    (
      "Could not update object parameter \"" + p_parameter->getName() + "\": corresponding item not found.",
      "void cedar::proc::aux::gui::Configurable::parameterChangeFlagChanged()"
    );
    return;
  }
...
QString cedar::proc::aux::gui::Configurable::getPathFromItem(QTreeWidgetItem* item)
{
  return item->data(PARAMETER_EDITOR_COLUMN, Qt::UserRole).toString();
}

void cedar::proc::aux::gui::Configurable::disconnect(QTreeWidgetItem* item)
{
...
void cedar::proc::aux::gui::Configurable::clear()
{
...
QTreeWidgetItem* cedar::proc::aux::gui::Configurable::getItemForParameter(cedar::aux::Parameter* parameter)
{
...
void cedar::proc::aux::gui::Configurable::updateLinkState(QTreeWidgetItem* item, cedar::aux::Parameter* pParameter)
{
...
void cedar::proc::aux::gui::Configurable::updateChangeState(QTreeWidgetItem* item, cedar::aux::Parameter* pParameter, bool firstUpdate)
{
  QFont font = item->font(PARAMETER_NAME_COLUMN);
