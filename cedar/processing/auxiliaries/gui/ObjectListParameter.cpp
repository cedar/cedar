...
namespace
{
  bool registered = cedar::proc::aux::gui::ParameterFactorySingleton::getInstance()->addDerived
      <
        ...
        cedar::proc::aux::gui::ObjectListParameter
      >();
}
...
cedar::proc::aux::gui::ObjectListParameter::ObjectListParameter()
{
  int margins = 0;
  int spacing = 2;
  int button_size = 20;
...
void cedar::proc::aux::gui::ObjectListParameter::parameterPointerChanged()
{
...
QString cedar::proc::aux::gui::ObjectListParameter::prettyTypeId(const QString& typeId) const
{
...
void cedar::proc::aux::gui::ObjectListParameter::addClicked()
{
  ...
  if(auto scene = cedar::proc::undoRedo::UndoCommand::sceneIfUndoable(parameter.get(), this))
  {
    cedar::proc::gui::Ide::pUndoStack->push(new cedar::proc::undoRedo::commands::ChangeObjectListParameterValue(
            parameter.get(), this->getSelectedType(), parameter->getNamedConfigurableOwner(), scene));
  }
  else
  {
