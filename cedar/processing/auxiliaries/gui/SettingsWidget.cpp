...
// CEDAR INCLUDES
#include "cedar/processing/auxiliaries/gui/SettingsWidget.h"
...
cedar::proc::aux::gui::SettingsWidget::SettingsWidget(QWidget *pParent)
:
QWidget(pParent)
{
  this->setupUi(this);
...
//  QObject::connect(this->mpYarpConfigString,SIGNAL(cedar::proc::aux::gui::Parameter::valueChanged()),this,SLOT(yarpConfigInfoChanged()));
...
void cedar::proc::aux::gui::SettingsWidget::fillPossible2dMatDataPlots()
{
...
void cedar::proc::aux::gui::SettingsWidget::default2dMatDataPlotChanged()
{
