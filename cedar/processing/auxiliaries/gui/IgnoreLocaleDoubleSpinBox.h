...
========================================================================================================================
    ...
    Description: Header file for the class cedar::proc::aux::gui::IgnoreLocaleDoubleSpinBox.
...
#include "cedar/processing/auxiliaries/gui/IgnoreLocaleDoubleSpinBox.fwd.h"
 ...
 * @todo describe more.
 */
class cedar::proc::aux::gui::IgnoreLocaleDoubleSpinBox: public QDoubleSpinBox
{
  Q_OBJECT
  //--------------------------------------------------------------------------------------------------------------------
  // nested types
...
}; // class cedar::proc::aux::gui::IgnoreLocaleDoubleSpinBox
