...
#include "cedar/processing/auxiliaries/gui/IntParameter.fwd.h"
 ...
 */
class cedar::proc::aux::gui::IntParameter : public cedar::proc::aux::gui::NumericParameter<int, QSpinBox>
{
  //--------------------------------------------------------------------------------------------------------------------
  // macros
  //--------------------------------------------------------------------------------------------------------------------
  ...
  //--------------------------------------------------------------------------------------------------------------------
private:
  typedef cedar::proc::aux::gui::NumericParameter<int, QSpinBox> Base;
...
}; // class cedar::proc::aux::gui::IntParameter
