...
namespace
{
  bool registered = cedar::proc::aux::gui::ParameterFactorySingleton::getInstance()->add
      <
        ...
        cedar::proc::aux::gui::UIntVectorParameter
      >();
}
...
cedar::proc::aux::gui::UIntVectorParameter::UIntVectorParameter(QWidget *pParent)
:
cedar::proc::aux::gui::UIntVectorParameter::Base(pParent)
{
}
...
void cedar::proc::aux::gui::UIntVectorParameter::widgetValueChanged(int)
{
