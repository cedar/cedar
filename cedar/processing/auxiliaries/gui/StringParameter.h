...
#include "cedar/processing/auxiliaries/gui/StringParameter.fwd.h"
 ...
 */
class cedar::proc::aux::gui::StringParameter : public cedar::proc::aux::gui::Parameter
{
  //--------------------------------------------------------------------------------------------------------------------
  // macros
  //--------------------------------------------------------------------------------------------------------------------
...
}; // class cedar::proc::aux::gui::StringParameter
