...
cedar::proc::aux::gui::DoubleParameter::DoubleParameter(QWidget *pParent)
:
cedar::proc::aux::gui::DoubleParameter::Base(pParent)
{
}

//!@brief Destructor
cedar::proc::aux::gui::DoubleParameter::~DoubleParameter()
{
}
...
void cedar::proc::aux::gui::DoubleParameter::parameterChanged()
{
...
void cedar::proc::aux::gui::DoubleParameter::valueChanged(double)
{
