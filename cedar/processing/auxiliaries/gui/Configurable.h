 ...
 */
class cedar::proc::aux::gui::Configurable : public QWidget
{
  Q_OBJECT
 ...
 */
class cedar::proc::aux::gui::Configurable::DataDelegate : public QStyledItemDelegate
{
  Q_OBJECT
public:
  //! Constructor for the DataDelegate.
  DataDelegate(cedar::proc::aux::gui::Configurable* configurableWidget, bool readOnly = false);
...
private:
  cedar::proc::aux::gui::Configurable* mConfigurableWidget;
