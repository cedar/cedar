...
#include "cedar/processing/auxiliaries/gui/UIntVectorParameter.fwd.h"
 ...
 */
class cedar::proc::aux::gui::UIntVectorParameter : public cedar::proc::aux::gui::NumericVectorParameter
                                                    <
                                                      unsigned int,
                                                      QSpinBox
                                                    >
{
  ...
  //--------------------------------------------------------------------------------------------------------------------
private:
  typedef cedar::proc::aux::gui::NumericVectorParameter<unsigned int, QSpinBox> Base;
...
}; // class cedar::proc::aux::gui::UIntVectorParameter
