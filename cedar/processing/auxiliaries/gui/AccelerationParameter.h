...
#include "cedar/processing/auxiliaries/gui/AccelerationParameter.fwd.h"
  ...
  namespace proc
  {
    namespace aux
    {
      namespace gui
      {
        ...
        template<>
        inline void
        NumericWidgetPolicy<cedar::unit::Acceleration, QDoubleSpinBox>::setPrecision(QDoubleSpinBox *pWidget,
                                                                                     int precision)
        {
        ...
        template<>
        inline void NumericWidgetPolicy<cedar::unit::Acceleration, QDoubleSpinBox>::setValue(QDoubleSpinBox *pWidget,
                                                                                             const cedar::unit::Acceleration &newValue)
        {
        ...
        NumericWidgetPolicy<cedar::unit::Acceleration, QDoubleSpinBox>::getValue(QDoubleSpinBox *pWidget)
        {
          return pWidget->value() * (cedar::unit::meters / (cedar::unit::seconds * cedar::unit::seconds));
        }

        template<>
        inline void NumericWidgetPolicy<cedar::unit::Acceleration, QDoubleSpinBox>::setMaximum(QDoubleSpinBox *pWidget,
                                                                                               const cedar::unit::Acceleration &newValue)
        {
        ...
        template<>
        inline void NumericWidgetPolicy<cedar::unit::Acceleration, QDoubleSpinBox>::setMinimum(QDoubleSpinBox *pWidget,
                                                                                               const cedar::unit::Acceleration &newValue)
        {
 ...
 */
class cedar::proc::aux::gui::AccelerationParameter : public cedar::proc::aux::gui::NumericParameter<cedar::unit::Acceleration, QDoubleSpinBox>
{
  //--------------------------------------------------------------------------------------------------------------------
  // macros
  //--------------------------------------------------------------------------------------------------------------------
...
}; // class cedar::proc::aux::gui::AccelerationParameter
