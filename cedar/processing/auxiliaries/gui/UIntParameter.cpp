...
cedar::proc::aux::gui::UIntParameter::UIntParameter(QWidget *pParent)
:
cedar::proc::aux::gui::UIntParameter::Base(pParent)
{
}

//!@brief Destructor
cedar::proc::aux::gui::UIntParameter::~UIntParameter()
{
}
...
void cedar::proc::aux::gui::UIntParameter::parameterChanged()
{
...
void cedar::proc::aux::gui::UIntParameter::valueChanged(int)
{
