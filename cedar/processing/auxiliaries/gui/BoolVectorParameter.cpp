...
cedar::proc::aux::gui::BoolVectorParameter::BoolVectorParameter(QWidget* pParent)
:
cedar::proc::aux::gui::BoolVectorParameter::Base(pParent)
{
}
...
void cedar::proc::aux::gui::BoolVectorParameter::widgetValueChanged(int)
{
