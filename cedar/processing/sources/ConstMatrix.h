...
#ifndef CEDAR_PROC_SOURCES_CONST_MATRIX_H
#define CEDAR_PROC_SOURCES_CONST_MATRIX_H
...
#include "cedar/processing/sources/ConstMatrix.fwd.h"
 ...
 *        x,y,... coordinates.
 */
class cedar::proc::sources::ConstMatrix : public cedar::proc::Step
{
  //--------------------------------------------------------------------------------------------------------------------
  // macros
  //--------------------------------------------------------------------------------------------------------------------
...
}; // class cedar::proc::source::ConstMatrix

#endif // CEDAR_PROC_SOURCES_CONST_MATRIX_H
