...
namespace
{
  bool declare()
  {
    ...
    (
      new ElementDeclarationTemplate<cedar::proc::sources::ConstDiagonalMatrix>
      (
        "Sources",
...
cedar::proc::sources::ConstDiagonalMatrix::ConstDiagonalMatrix()
:
cedar::proc::Step(),
...
void cedar::proc::sources::ConstDiagonalMatrix::compute(const cedar::proc::Arguments&)
{
  auto siz = _mSizes->getValue();

  this->mOutput->setData( cv::Mat::eye( siz[0], siz[1], CV_32F )
                          * _mConst->getValue() 
                        );
}

void cedar::proc::sources::ConstDiagonalMatrix::updateMatrix()
{
  this->onTrigger();
}

void cedar::proc::sources::ConstDiagonalMatrix::updateMatrixSize()
{
