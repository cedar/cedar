...
//----------------------------------------------------------------------------------------------------------------------
  ...
  {
    this->setArmPosition(true);
  }

  void cedar::dev::kteam::KheperaDrive::closeGripper()
  {
    this->setArmPosition(false);
  }
  ...
  void cedar::dev::kteam::KheperaDrive::setGripperPosition(bool position)
  {
    ...
    command << getCommandCharacterSetGripperPosition() << "," << static_cast<unsigned int>(position);
  ...
  void cedar::dev::kteam::KheperaDrive::setArmPosition(unsigned int position)
  {
    ...
    std::ostringstream command;
    command << getCommandCharacterSetArmPosition() << "," << position;
    // send the command string
    getSerialCommunication()->lock();
    getSerialCommunication()->send(command.str());
    // receive an answer
  ...
  unsigned int cedar::dev::kteam::KheperaDrive::getArmPosition()
  {
    ...
    getSerialCommunication()->lock();
    getSerialCommunication()->send(cedar::aux::toString(getCommandCharacterGetArmPosition()));
    std::string answer = getSerialCommunication()->receive();
    getSerialCommunication()->unlock();

    // check whether the first character of the answer is correct
    checkAnswer(answer, getCommandCharacterGetArmPosition()[0]);
  ...
  unsigned int cedar::dev::kteam::KheperaDrive::getGripperPosition()
  {
    ...
    // send a command string to the robot to receive the current acceleration values
    getSerialCommunication()->lock();
    getSerialCommunication()->send(cedar::aux::toString(getCommandCharacterGetGripperPosition()));
    std::string answer = getSerialCommunication()->receive();
    getSerialCommunication()->unlock();

    // check whether the first character of the answer is correct
    checkAnswer(answer, getCommandCharacterGetGripperPosition()[0]);
  ...
  unsigned int cedar::dev::kteam::KheperaDrive::getGripperOpticalSensor()
  {
    ...
    // send a command string to the robot to receive the current acceleration values
    getSerialCommunication()->lock();
    getSerialCommunication()->send(cedar::aux::toString(getCommandCharacterGetGripperOpticalSensor()));
    std::string answer = getSerialCommunication()->receive();
    getSerialCommunication()->unlock();

    // check whether the first character of the answer is correct
    checkAnswer(answer, getCommandCharacterGetGripperOpticalSensor());
  ...
  unsigned int cedar::dev::kteam::KheperaDrive::getGripperResistivity()
  {
    ...
    // send a command string to the robot to receive the current acceleration values
    getSerialCommunication()->lock();
    getSerialCommunication()->send(cedar::aux::toString(getCommandCharacterGetGripperResistivity()));
    std::string answer = getSerialCommunication()->receive();
    getSerialCommunication()->unlock();

    // check whether the first character of the answer is correct
    checkAnswer(answer, getCommandCharacterGetGripperResistivity());
  ...
  void cedar::dev::kteam::KheperaDrive::setLEDState(unsigned int ledId, bool state)
  {
    ...
    std::ostringstream command;
    command << getCommandCharacterSetLEDState() << "," << ledId << "," << state;
    // send the command string
    getSerialCommunication()->lock();
    getSerialCommunication()->send(command.str());
    // receive an answer
    ...
    // check whether the answer begins with the correct character
    checkAnswer(answer, getCommandCharacterSetLEDState());
  ...
  std::vector<unsigned int> cedar::dev::kteam::KheperaDrive::getProximitySensors()
  {
    ...
    getSerialCommunication()->lock();
    getSerialCommunication()->send(cedar::aux::toString(getCommandCharacterGetProximitySensors()));
    std::string answer = getSerialCommunication()->receive();
    getSerialCommunication()->unlock();

    // check whether the answer begins with the correct character
    checkAnswer(answer, getCommandCharacterGetProximitySensors());
  ...
  std::vector<unsigned int> cedar::dev::kteam::KheperaDrive::getAmbientSensors()
  {
    ...
    // send the command to receive the values of the encoders
    getSerialCommunication()->lock();
    getSerialCommunication()->send(cedar::aux::toString(getCommandCharacterGetAmbientSensors()));
    std::string answer = getSerialCommunication()->receive();
    getSerialCommunication()->unlock();

    // check whether the answer begins with the correct character
    checkAnswer(answer, getCommandCharacterGetAmbientSensors());
  ...
  char cedar::dev::kteam::KheperaDrive::getCommandCharacterSetGripperPosition() const
  {
    return 'D';
  }

  std::string cedar::dev::kteam::KheperaDrive::getCommandCharacterGetGripperPosition() const
  {
    return "H,0";
  }

  char cedar::dev::kteam::KheperaDrive::getCommandCharacterSetArmPosition() const
  {
    return 'E';
  }

  std::string cedar::dev::kteam::KheperaDrive::getCommandCharacterGetArmPosition() const
  {
    return "H,1";
  }

  char cedar::dev::kteam::KheperaDrive::getCommandCharacterGetGripperOpticalSensor() const
  {
    return 'G';
  }

  char cedar::dev::kteam::KheperaDrive::getCommandCharacterGetGripperResistivity() const
  {
    return 'F';
  }

  char cedar::dev::kteam::KheperaDrive::getCommandCharacterSetLEDState() const
  {
    return 'L';
  }

  char cedar::dev::kteam::KheperaDrive::getCommandCharacterGetProximitySensors() const
  {
    return 'N';
  }

  char cedar::dev::kteam::KheperaDrive::getCommandCharacterGetAmbientSensors() const
  {
    return 'O';
  }


void cedar::dev::kteam::KheperaDrive::readConfiguration(const cedar::aux::ConfigurationNode& node)
{
