...
void cedar::dev::robot::ReferenceGeometry::init()
{
  ...
  for (unsigned int i = 0; i < number_of_joints; ++i)
  {
    ...
    addParameter(&(p_joint->angleLimits.mLowerLimit), parameter_path + "angleLimits.[0]", 0.0);
    addParameter(&(p_joint->angleLimits.mLowerLimit), parameter_path + "angleLimits.[1]", 0.0);
    addParameter(&(p_joint->velocityLimits.mLowerLimit), parameter_path + "velocityLimits.[0]", 0.0);
    addParameter(&(p_joint->velocityLimits.mUpperLimit), parameter_path + "velocityLimits.[1]", 0.0);
  }
