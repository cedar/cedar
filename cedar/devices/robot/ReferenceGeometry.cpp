...
cedar::dev::robot::ReferenceGeometry::ConstJointPtr cedar::dev::robot::ReferenceGeometry::getJoint
                                                    (
                                                      unsigned int index
                                                    ) const
{
...
cedar::dev::robot::ReferenceGeometry::ConstEndEffectorPtr cedar::dev::robot::ReferenceGeometry::getEndEffector() const
{
  return _mpEndEffector;
}

cedar::dev::robot::ReferenceGeometry::ConstLinkSegmentPtr cedar::dev::robot::ReferenceGeometry::getLinkSegment
                                                          (
                                                            unsigned int index
                                                          ) const
{
