...
{
  #ifdef DEBUG_CAMERAGRABBER
    std::cout << "[cedar::dev::sensors::visual::CameraGrabber::CameraGrabber] Create stereo channel instance" << std::endl;
  #endif
  ...
  #ifdef DEBUG_CAMERAGRABBER
    //std::cout << "cam0: guid " << mCamIds.at(0).guid << " busid: " << mCamIds.at(0).busId << std::endl;
    //std::cout << "cam1: guid " << mCamIds.at(1).guid << " busid: " << mCamIds.at(1).busId << std::endl;
    std::cout << "[cedar::dev::sensors::visual::CameraGrabber::CameraGrabber] Update configuration file" << std::endl;
  #endif
  cedar::aux::ConfigurationInterface::writeConfiguration();
}
...
//----------------------------------------------------------------------------------------------------
void cedar::dev::sensors::visual::CameraGrabber::printAllSettings(unsigned int channel)
{
  //todo: check if this function is needed and working
  if (channel >= mNumCams)
  {
    CEDAR_THROW(cedar::aux::exc::IndexOutOfRangeException,"cedar::dev::sensors::visual::CameraGrabber::printAllSettings");
  }
...
//----------------------------------------------------------------------------------------------------
void cedar::dev::sensors::visual::CameraGrabber::printAllProperties(unsigned int channel)
{
  //todo: check if this function is needed and working
  if (channel >= mNumCams)
  {
    CEDAR_THROW(cedar::aux::exc::IndexOutOfRangeException,"cedar::dev::sensors::visual::CameraGrabber::printAllProperties");
  }
...
unsigned int cedar::dev::sensors::visual::CameraGrabber::getCameraGuid(unsigned int channel)
{
  if (channel >= mNumCams)
  {
    CEDAR_THROW(cedar::aux::exc::IndexOutOfRangeException,"cedar::dev::sensors::visual::CameraGrabber::getCameraProperty");
  }
...
//----------------------------------------------------------------------------------------------------
bool cedar::dev::sensors::visual::CameraGrabber::setCameraProperty(unsigned int channel,CameraProperty::Id propId, double value)
{
  #ifdef DEBUG_CAMERAGRABBER
  ...
  if (channel >= mNumCams)
  {
    CEDAR_THROW(cedar::aux::exc::IndexOutOfRangeException,"cedar::dev::sensors::visual::CameraGrabber::setCameraProperty");
  }
...
{
  return static_cast<CameraVideoMode::Id>(getCameraSetting
                                          (
                                            channel,
                                            cedar::dev::sensors::visual::CameraSetting::SETTING_ISO_SPEED)
                                          );
