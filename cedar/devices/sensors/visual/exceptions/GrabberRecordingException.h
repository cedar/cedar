...
#ifndef CEDAR_AUX_EXC_GRABBER_RECORDING_EXCEPTION_H
#define CEDAR_AUX_EXC_GRABBER_RECORDING_EXCEPTION_H
 ...
 * This exception should be thrown when an error occurs during recording.
  */
class cedar::aux::exc::GrabberRecordingException : public cedar::aux::exc::ExceptionBase
{
  //--------------------------------------------------------------------------------------------------------------------
  // macros
  //--------------------------------------------------------------------------------------------------------------------
...
#endif // CEDAR_AUX_EXC_GRABBER_RECORDING_EXCEPTION_H
