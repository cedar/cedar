...
// creates the parameter storage needed for configuration interface
 ...
 {
    #ifdef DEBUG_CAMERAGRABBER
      std::cout << "[CameraState::getAllParametersToCam]" << std::endl;
    #endif
...
/*
   #ifdef DEBUG_CAMERAGRABBER
     std::cout << "[CameraState::getAllParametersFromCam] Read videomode of: " << mode << std::endl;
     std::cout << "[CameraState::getAllParametersFromCam] Read FPS of: " << fps << std::endl;
     std::cout << "[CameraState::getAllParametersFromCam] Read ISO-speed of: " << iso << std::endl;
     ...
     std::cout << "[CameraState::getAllParametersFromCam] Read frame width of: " << width << std::endl;
     std::cout << "[CameraState::getAllParametersFromCam] Read frame height of: " << height << std::endl;
     std::cout << "[CameraState::getAllParametersFromCam] Camera configuration file: " << config << std::endl;
   #endif
*/
   ...
   /*
   #ifdef DEBUG_CAMERAGRABBER
     std::cout << "[CameraState::getAllParametersFromCam] All Properties of camera: "<< std::endl;
     //printAllProperties(channel);
   #endif
