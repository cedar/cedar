...
//mCamConfigFileStorage(NULL)
{
  ...
  try
  {
    ...
    mpCamConfigFileStorage = CameraConfigFileStoragePtr(new CameraConfigFileStorage (videoCapture,mChannelPrefix,supp_prop,mConfigurationFileName));
  }
...
bool CameraConfiguration::writeConfiguration()
{
  ...
  return mpCamConfigFileStorage->writeConfiguration();
}
