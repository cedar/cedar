...
find_package(Qt5PrintSupport 5.5.0 REQUIRED)
...
find_package(Qt5OpenGL 5.5.0 REQUIRED)
if(Qt5OpenGL_FOUND)
...
find_package(Qt5Charts 5.5.0 QUIET)
if(Qt5Charts_FOUND)
...
find_package(Qt5DataVisualization 5.5.0 QUIET)
...
find_package(Qt53DCore 5.5.0 QUIET)
if(Qt53DCore_FOUND)
...
find_package(Qt53DExtras 5.5.0 QUIET)
...
find_package(Qt53DInput 5.5.0 QUIET)
if(Qt53DInput_FOUND)
...
find_package(Qt53DLogic 5.5.0 QUIET)
if(Qt53DLogic_FOUND)
...
find_package(Qt53DRender 5.5.0 QUIET)
...
find_package(Qt5OpenGL 5.5.0 QUIET)
if(Qt5OpenGL_FOUND)
  set(CEDAR_THIRD_PARTY_LIBS ${CEDAR_THIRD_PARTY_LIBS} ${Qt5OpenGL_LIBRARIES})
  include_directories(${Qt5OpenGL_INCLUDE_DIRS})
  add_definitions(${Qt5OpenGL_DEFINITIONS})
...
find_package(Qt5Xml 5.5.0 REQUIRED)
if(Qt5Xml_FOUND)
...
find_package(Qt5Svg 5.5.0 REQUIRED)
if(Qt5Svg_FOUND)
...
find_package(Qt5Concurrent 5.5.0 QUIET)
