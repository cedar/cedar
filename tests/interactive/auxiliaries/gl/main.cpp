...
int main(int argc, char **argv)
{
  ...
  p_block_local_coordinate_frame->setPosition(3, -3, 3);
  ...
  p_sphere_local_coordinate_frame->setPosition(3, 3, 3);
  ...
  p_cone_local_coordinate_frame->setPosition(-3, 3, 3);
  ...
  p_cylinder_local_coordinate_frame->setPosition(-3, -3, 3);
  ...
  p_pyramid_local_coordinate_frame->setPosition( 9, -3, 3 );
  ...
  p_prism_local_coordinate_frame->setPosition(0, 0, 5);
  ...
  p_torus_local_coordinate_frame->setPosition( -7.5, 3, 3 );
  ...
  p_ellipse_local_coordinate_frame->setPosition(-7.5, -3, 3);
  ...
  p_chessboard_local_coordinate_frame->setPosition( 7.5, 1.5, 3 );
