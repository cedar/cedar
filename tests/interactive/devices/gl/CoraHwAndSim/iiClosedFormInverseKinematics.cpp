...
int ClosedFormInverseKinematics::TaskCoordinatesToArmGeometry()
{
  ...
  //printf("eefPos = \n");
  //mCalculatedHandState.eefPos.StdOutFormatted();
...
void ClosedFormInverseKinematics::InverseKinematics()
{
	...
	cout << "Angle 3 = " << mJointAngle.at<double>(3, 0) << "Angle 4 = " << mJointAngle.at<double>(4, 0) << "\n\n\n\n";
	...
	cout << "Angle 5 = " << mJointAngle.at<double>(5, 0) << "Angle 6 = " << mJointAngle.at<double>(6, 0) << "\n\n\n\n";
	...
	cout << "Angle 7 =  " << mJointAngle.at<double>(7, 0) << "\n";
	return;
}
