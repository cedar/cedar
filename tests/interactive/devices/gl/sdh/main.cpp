...
int main(int argc, char **argv)
{
  ...
  cedar::dev::KinematicChainPtr p_dummy_arm(new cedar::dev::SimulatedKinematicChain());
  ...
  cedar::dev::gl::SdhPtr p_hand_visualization
  (
    new cedar::dev::gl::Sdh(p_dummy_arm)
  );
  ...
  cedar::dev::gui::KinematicChainWidget widget_arm(p_dummy_arm);
