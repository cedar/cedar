...
int main(int , char **)
{
  ...
  const char* grabbername = "Picture_grabber_TestCase";
  const char* configfile ="picture_grabber_TestCase.configfile";
  ...
  cedar::dev::sensors::visual::PictureGrabber picture_grabber(configfile,filename0);
   ...
   */
    ...
    std::cout << "\nGrab from (0) " << picture_grabber.getSourceInfo()<< std::endl;
