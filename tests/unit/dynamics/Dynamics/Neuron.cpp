...
:
mRestingLevel(new cedar::aux::DoubleParameter("restingLevel", restingLevel)),
mInteractionWeight(new cedar::aux::DoubleParameter("interactionWeight", interactionWeight)),
