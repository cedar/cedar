...
int main()
{
  ...
  p.at<double>(2, 0) = 1.0;
  p.at<double>(3, 0) = 1.0;
  cv::Mat v0 = test_arm->calculateVelocity(p, 0, cedar::dev::KinematicChain::LOCAL_COORDINATES);
  cv::Mat v1 = test_arm->calculateVelocity(p, 1, cedar::dev::KinematicChain::LOCAL_COORDINATES);
  cv::Mat v2 = test_arm->calculateVelocity(p, 2, cedar::dev::KinematicChain::LOCAL_COORDINATES);
  cv::Mat v3 = test_arm->calculateVelocity(p, 3, cedar::dev::KinematicChain::LOCAL_COORDINATES);
  if (
  ...
  cv::Mat a0
    = acceleration_test_arm->calculateAcceleration(p, 0, cedar::dev::KinematicChain::LOCAL_COORDINATES);
  cv::Mat a1
    = acceleration_test_arm->calculateAcceleration(p, 1, cedar::dev::KinematicChain::LOCAL_COORDINATES);
  ...
  (
    ...
    cedar::dev::KinematicChain::WORLD_COORDINATES
  );
  if (
