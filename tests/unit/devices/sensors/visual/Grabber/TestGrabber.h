...
public:
	...
	{
    std::cout<<"TestGrabber::TestGrabber (single channel)\n";
	...
	:   GrabberInterface(configFileName)
	{
    std::cout<<"TestGrabber::TestGrabber (dual channel)\n";
	...
	~TestGrabber()
	{
	  std::cout<<"TestGrabber::Destructor\n";
	}
	...
	bool onInit()
	{
	  ...
	  //-------------------------------------------------
	  std::cout << "\n\nTestGrabber.onInit()\n";
	  std::cout << "TestGrabber: Initialize Grabber with " << mNumCams << " channels ..." << std::endl;
	  std::cout << "TestGrabber from channel:\n  - " << mChannelVector.at(0) << "\n";
